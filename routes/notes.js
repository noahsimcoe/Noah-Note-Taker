...
// GET, retrieves all notes that are stored from db.json file
router.get("/notes", (req, res) => (
    readFromFile("./db/db.json")).then((data) => res.json(JSON.parse(data)))
);

// POST, adds new notes with randomly generated id's
...
// DELETE, deletes a specified note determined by its id
